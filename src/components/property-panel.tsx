...
export const PropertyPanel = () => {
  ...
  if (!selectedField) {
    return (
      <aside className="w-80 border-l border-gray-200 flex flex-col" style={{ background: 'linear-gradient(to bottom, #f9fafb, #ffffff)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center">
            <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: 'linear-gradient(135deg, #f3f4f6, #e5e7eb)' }}>
              <Settings className="w-10 h-10 text-gray-300" />
            </div>
            <h3 className="text-lg font-semibold text-gray-700 mb-2">No Field Selected</h3>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-white/60 backdrop-blur-sm rounded-lg border border-gray-200">
              <div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {selectedField.options?.map((option, index) => (
                <Card key={option.id} className="p-4 bg-white/80 backdrop-blur-sm border border-gray-200 hover:border-gray-300 transition-all duration-200">
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 rounded-lg flex items-center justify-center text-blue-600 text-xs font-semibold" style={{ background: 'linear-gradient(135deg, #dbeafe, #e9d5ff)' }}>
                      {index + 1}
                    </div>
                    <div className="flex-1 space-y-2">
                      <Input
                        ...
                        className="text-sm bg-white/60 backdrop-blur-sm border-gray-200 focus:border-blue-500 focus:ring-blue-500"
                      />
                      <Input
                        value={option.value}
            ...
            <div className="space-y-6">
              ...
              {selectedField.type === "number" && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="field-min" className="text-sm font-medium text-gray-700 mb-2 block">
                      Min Value
                    </Label>
                    <Input
                      id="field-min"
                  ...
                  <div>
                    <Label htmlFor="field-max" className="text-sm font-medium text-gray-700 mb-2 block">
                      Max Value
                    </Label>
                    <Input
                      id="field-max"
              ...
              {selectedField.type === "text" && (
                <div>
                  <Label htmlFor="field-pattern" className="text-sm font-medium text-gray-700 mb-2 block">
                    Pattern (Regex)
                  </Label>
                  <Input
                    id="field-pattern"
